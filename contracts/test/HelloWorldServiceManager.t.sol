...
contract HelloWorldTaskManagerSetup is Test {
    ...
    function createTask(
        ...
        IHelloWorldServiceManager helloWorldServiceManager = IHelloWorldServiceManager(
                helloWorldDeployment.helloWorldServiceManager
            );
...
contract HelloWorldServiceManagerInitialization is HelloWorldTaskManagerSetup {
    function testInitialization() public view {
        ...
        assertTrue(
            helloWorldDeployment.stakeRegistry != address(0),
...
contract CreateTask is HelloWorldTaskManagerSetup {
    ...
    function testCreateTask() public {
        ...
        uint8 requiredValidatorResponses = 1;
        ...
        require(
            sha256(abi.encodePacked(newTask.name)) ==
                sha256(abi.encodePacked(taskName)),
